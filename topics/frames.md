...
To map point representations along consecutive frames, we multiply homogeneous points by consecutive transforms to their left. For instance, to re-express a point from frame $C$ to $B$ to $A$, we write:
